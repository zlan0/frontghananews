  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="space-y-4">
        <div className="bg-white rounded-xl shadow-sm p-6">
          <h3 className="font-bold text-gray-800 mb-4">🚀 First Time Setup</h3>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4 text-sm text-blue-800">
            <p className="font-bold mb-2">Run these URLs in order to initialize your site:</p>
            <ol className="space-y-2 list-decimal list-inside">
              <li><a href="/api/init" target="_blank" className="font-mono underline">/api/init</a> — Create database tables &amp; seed RSS sources</li>
              <li><a href="/api/cron/rss" target="_blank" className="font-mono underline">/api/cron/rss</a> — Fetch first batch of articles from RSS</li>
              <li><a href="/api/cron/scrape" target="_blank" className="font-mono underline">/api/cron/scrape</a> — Scrape additional articles</li>
            </ol>
          </div>
          <h4 className="font-bold text-gray-700 mb-2 mt-4">Environment Variables</h4>
          <p className="text-sm text-gray-600 mb-4">
            Set these in <strong>Vercel → Settings → Environment Variables</strong>, then redeploy.
          </p>
